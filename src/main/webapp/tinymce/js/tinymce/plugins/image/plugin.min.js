...
!function () {
    ...
    var i, o = tinymce.util.Tools.resolve("tinymce.PluginManager"), v = function () {
        ...
        }, T = e("string"), s = e("object"), c = e("array"), N = t("boolean"), w = t("function"), u = t("number"),
        m = a(!1), d = a(!(i = null)), g = {
            fold: function (e, t) {
                return e()
            },
    ...
    var b = function (n) {
        ...
        some: b, none: r, from: function (e) {
            return null == e ? g : b(e)
        }
    }, y = Object.keys, A = Object.hasOwnProperty, U = Array.prototype.push;
    ...
    function ne(e, t) {
        var n = _(e.dom.styles.parse(t)), r = e.dom.styles.parse(e.dom.styles.serialize(n));
    ...
    function ie(n, e) {
        var r, t, i = n.dom, a = (f(n.schema.getTextBlockElements(), function (e, t) {
            ...
            r[t] = e
        }), l), t), o = i.getParent(e.parentNode, function (e) {
    ...
    function ae(r, e) {
        var t = function (e) {
            ...
            if (Ce(function (e) {
                return ne(r, e)
            }, v(v({}, e), {caption: !1}), t), Ie(t, e.alt, e.isDecorative), e.caption) {
    ...
    function oe(t, e) {
        ...
        b ? (n = Y(function (e) {
            return ne(t, e)
        }, b), r = v(v({}, n), e), s = t, c = r.src, i = v(v({}, r), {src: R(s, c) ? c : ""}), r.src ? (m = i, h = re(u = t), Ce(function (e) {
            return ne(u, e)
    ...
    function ge(l, s, t, c) {
        ...
        c.block("Uploading image"), (0 < (e = n.fileinput).length ? L.some(e[0]) : L.none()).fold(function () {
            ...
            var a = URL.createObjectURL(n), o = n;
            new De(function (e, t) {
        ...
        var t, n, r, i, a, o, l, s, c, A = {
            onSubmit: function (n) {
                ...
                return R(s, e) ? (i = s.documentBaseURI.toAbsolute(e), new De(function (t) {
                    ...
                    r.onload = function () {
                        var e = x(r.width, r.clientWidth), t = x(r.height, r.clientHeight);
        ...
        return {
            open: function () {
                ...
                r = v, i = Pe(function (e) {
                    ...
                    var t, n, r, i = {prevImage: Ee((t = e).imageList, t.image.src), prevAlt: t.image.alt, open: !0};
                    return {
    ...
    var ye, ve = be, Ae = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
        De = tinymce.util.Tools.resolve("tinymce.util.Promise"), we = tinymce.util.Tools.resolve("tinymce.util.URI"),
        Se = tinymce.util.Tools.resolve("tinymce.util.XHR"), Ue = Ae.DOM, Ie = function (e, t, n) {
            ...
            ee(n, r, t, "caption", function (e, t, n) {
                return H(r = e) ? (o = r.parentNode, Ue.insertAfter(r, o), Ue.remove(o)) : (i = r, a = Ue.create("figure", {class: "image"}), Ue.insertAfter(a, i), a.appendChild(i), a.appendChild(Ue.create("figcaption", {contentEditable: "true"}, "Caption")), a.contentEditable = "false"), 0;
                var r, i, a, o
        ...
        Te = tinymce.util.Tools.resolve("tinymce.util.Tools"), Ne = function (e, a) {
            var o = [];
            return Te.each(e, function (e) {
                var t, n, r, i = T((t = e).text) ? t.text : T(t.title) ? t.title : "";
                void 0 !== e.menu ? (n = Ne(e.menu, a), o.push({text: i, items: n})) : (r = a(e), o.push({
                    text: i,
                    value: r
                }))
            }), o
